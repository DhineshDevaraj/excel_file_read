...
def main():
    ...
    df_0_to_48_hrs_df.to_csv(path + "\\" + "SAMPLE_RECEIVED_LESS_THAN_48_HRS" + ".csv")
    ...
    df_72_hrs_to_higher_df.to_csv(path + "\\" + "SAMPLE_RECEIVED_AFTER_72_HRS" + ".csv")
    ...
    df_48_to_72_hrs_df.to_csv(path + "\\" + "SAMPLE_RECEIVED_BETWEEN_48_TO_72_HRS" + ".csv")
    ...
    plt.show()
    print("All Sample Received between the given time interval has been saved successfully")
